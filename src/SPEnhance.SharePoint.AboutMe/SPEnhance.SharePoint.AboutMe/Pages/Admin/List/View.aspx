...
<html lang="en">
	<head>
        ...
        <script type="text/javascript">
            ...
            $("head").append('<script type="text/javascript" src="../../../Scripts/Admin/List/View.min.js?v=' + projectVersion + '">');
        </script>
	</head>
	<body>
		<!--[if lt IE 8]>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<p class="text-right">
						...
						<input type="button" id="deleteAllListData" value="Delete All" style="display:none"/>
					</p>
					<span id="listData">Loading...</span>
